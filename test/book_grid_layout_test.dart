...
void main() {
  ...
  test('调整窗口宽度后卡片不会溢出，骨架与正文横向对齐', () {
    for (final width in <double>[320, 390, 520, 639, 640, 800, 1100, 1280, 1920]) {
      ...
      final tiles = layout.tileGridDelegate()
          as SliverGridDelegateWithFixedCrossAxisCount;
      final skeleton = layout.skeletonGridDelegate()
          as SliverGridDelegateWithFixedCrossAxisCount;
